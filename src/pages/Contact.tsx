...
const Contact = () => {
  ...
  // Scroll to hash section (map) smoothly
  useEffect(() => {
    if (hash) {
                ...
                <div className="space-y-10">
                  <div className="flex items-start space-x-5">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      ...
                      >
                        G-11 to G-13 Link Road, Main Service Road <br />
                        Near Srinagar Highway Islamabad, Pakistan
                      </a>
                    </p>
                  </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-5">
                    ...
                    <p className="text-muted-foreground text-lg font-medium">
                      <a href="tel:+923345215337" className="hover:underline text-accent">
                        +92 334 5215337
                      </a>
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-5">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-lg font-medium">info@autoclassmotors.com</p>
                    </div>
                  </div>
